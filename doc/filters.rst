...
* ``mode``, ``model``: model selection mode (see `README <README.rst>` for details)

Example::

    threshold:8.0:100dca_FADE_-100_26_20_-2_2:cluster:1,threshold:-6.0:100dca_FADE_-100_26_20_-2_2:cluster:1

This uses the first cluster of the ``100dca_FADE_-100_26_20_-2_2`` predicton
as target PDB file. All DCA contacts whose distance is between 6Å and 8Å in
the target PDB are kept.
